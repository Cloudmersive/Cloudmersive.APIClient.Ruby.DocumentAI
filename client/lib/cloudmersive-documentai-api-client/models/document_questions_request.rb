...
module CloudmersiveDocumentaiApiClient
  class DocumentQuestionsRequest
    ...
    def self.swagger_types
      {
        :'input_file' => :'String',
        :'questions_yes_no' => :'Array<DocumentQuestionBoolean>',
        :'questions_multiple_choice' => :'Array<DocumentQuestionMultipleChoice>',
        :'questions_free_response' => :'Array<DocumentQuestionFreeResponse>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'QuestionsYesNo')
        if (value = attributes[:'QuestionsYesNo']).is_a?(Array)
          self.questions_yes_no = value
        end
      end

      if attributes.has_key?(:'QuestionsMultipleChoice')
        if (value = attributes[:'QuestionsMultipleChoice']).is_a?(Array)
          self.questions_multiple_choice = value
        end
      end

      if attributes.has_key?(:'QuestionsFreeResponse')
        if (value = attributes[:'QuestionsFreeResponse']).is_a?(Array)
          self.questions_free_response = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          questions_yes_no == o.questions_yes_no &&
          questions_multiple_choice == o.questions_multiple_choice &&
          questions_free_response == o.questions_free_response &&
    ...
    def hash
      [input_file, questions_yes_no, questions_multiple_choice, questions_free_response, recognition_mode].hash
    end
