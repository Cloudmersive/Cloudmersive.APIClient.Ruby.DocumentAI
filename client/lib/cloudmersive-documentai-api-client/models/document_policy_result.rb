...
module CloudmersiveDocumentaiApiClient
  ...
  class DocumentPolicyResult
    ...
    def self.swagger_types
      {
        ...
        :'risk_score' => :'Float',
        :'rule_violations' => :'Array<PolicyRuleViolation>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'RuleViolations')
        if (value = attributes[:'RuleViolations']).is_a?(Array)
          self.rule_violations = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          rule_violations == o.rule_violations
    end
    ...
    def hash
      [clean_result, risk_score, rule_violations].hash
    end
