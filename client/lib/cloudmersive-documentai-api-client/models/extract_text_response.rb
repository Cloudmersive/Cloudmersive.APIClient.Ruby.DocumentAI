...
module CloudmersiveDocumentaiApiClient
  ...
  class ExtractTextResponse
    ...
    def self.swagger_types
      {
        :'successful' => :'BOOLEAN',
        :'page_results' => :'Array<ExtractedTextPage>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'PageResults')
        if (value = attributes[:'PageResults']).is_a?(Array)
