...
module CloudmersiveDocumentaiApiClient
  ...
  class FieldValue
    ...
    attr_accessor :additional_field_string_values
    ...
    def self.swagger_types
      {
        ...
        :'additional_field_string_values' => :'Array<String>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'AdditionalFieldStringValues')
        if (value = attributes[:'AdditionalFieldStringValues']).is_a?(Array)
          self.additional_field_string_values = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          additional_field_string_values == o.additional_field_string_values
    end
    ...
    def hash
      [field_name, field_string_value, additional_field_string_values].hash
    end
