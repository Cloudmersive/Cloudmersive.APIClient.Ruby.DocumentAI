...
module CloudmersiveDocumentaiApiClient
  ...
  class TableResultCell
    # Cell column header
    attr_accessor :cell_header
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'CellHeader')
        self.cell_header = attributes[:'CellHeader']
      end

      if attributes.has_key?(:'CellValue')
        self.cell_value = attributes[:'CellValue']
      end
    end
