...
module CloudmersiveDocumentaiApiClient
  ...
  class DocumentQuestionMultipleChoice
    ...
    attr_accessor :response_choices
    ...
    def self.swagger_types
      {
        ...
        :'response_choices' => :'Array<DocumentQuestionChoiceItem>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ResponseChoices')
        if (value = attributes[:'ResponseChoices']).is_a?(Array)
          self.response_choices = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          response_choices == o.response_choices
    end
    ...
    def hash
      [question_id, question_text, response_choices].hash
    end
